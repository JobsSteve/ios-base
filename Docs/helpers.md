...
```objc
@interface ARTAppTheme : NSObject
...
@interface ARTAppTheme ()
@end

@implementation ARTAppTheme
...
### Работа с ARTAppTheme

```objc
[ARTAppTheme shared] blueBackgroundColor]
